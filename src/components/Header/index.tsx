...
import { setSearchQuery, setSearchPhotos, setSearchCollections } from "@context/actions";
      ...
      <div className="h-16 flex items-center px-5">
        <div className="flex-1 flex items-center">
          ...
          <form
            ...
            className="transition duration-300 ease-in-out w-full h-10 flex items-center rounded-full bg-gray-100 px-5 hover:ring-1 hover:ring-gray-200 focus-within:bg-white focus-within:ring-1 focus-within ring-gray-200"
          >
          ...
          <div className="ml-5">
            <Link href="/collections">
              <span className="text-gray-500 hover:text-gray-700 font-medium cursor-pointer">
                Collections
              </span>
            </Link>
          </div>
