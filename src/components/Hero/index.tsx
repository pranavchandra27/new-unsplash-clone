          ...
          <div className="w-full mx-4 pt-20 pb-16 md:w-4/6 md:mx-auto md:pt-36 md:pb-[132px]">
            ...
            <div className="hidden md:block">
              <form
                ...
                className="flex items-center w-full bg-white h-14 rounded-md px-4 hover:ring-4 hover:ring-black hover:ring-opacity-10 focus-within:ring-4 focus-within:ring-black focus-within:ring-opacity-10"
              >
